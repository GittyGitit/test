...
def main():
    ...
    st.set_page_config(page_title="윤예린", page_icon="❤️")  # 웹 페이지 제목과 아이콘 설정
    st.image('cat.png')  # 상단에 이미지를 표시
    st.title("_:red[고양이 마법]_ 😜")  # 제목 표시 (에너지 학습 도우미)
    st.header("😶주의! 귀여운 고양이 꿈을 꿀 겁니다", divider='rainbow')  # 주의사항 표시
